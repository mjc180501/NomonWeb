...
export class BroderClocks {
     ...
     * @param {Array<number>} results.2 - the prior distribution for the clocks_li given the new lm results
    ...
    init_round(is_win, is_start, clock_score_prior) {
        ...
        for (var i in this.clock_inf.clocks_li) {
            clock_ind = this.clock_inf.clocks_li[i];
